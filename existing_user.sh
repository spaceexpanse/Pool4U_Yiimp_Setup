...
whoami=`whoami`
echo -e "$CYAN Modifying existing user $whoami for yiimp server setup support.$COL_RESET"
...
##clear
echo -e "$CYAN Your User has been modified for yiimp server setup support...$COL_RESET"
